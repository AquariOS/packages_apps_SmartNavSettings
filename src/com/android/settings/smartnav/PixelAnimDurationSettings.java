...
import com.aquarios.support.preferences.SecureSeekBarPreference;
...
public class PixelAnimDurationSettings extends SettingsPreferenceFragment implements
    ...
    private SecureSeekBarPreference mPixelx;
    private SecureSeekBarPreference mPixely;
    private SecureSeekBarPreference mCollapse;
    private SecureSeekBarPreference mBg;
    private SecureSeekBarPreference mRetract;
    private SecureSeekBarPreference mDiamond;
    private SecureSeekBarPreference mDots;
    private SecureSeekBarPreference mHome;
    ...
    public void refreshSettings() {
        ...
        mPixelx =
                (SecureSeekBarPreference) findPreference(PIXEL_X);
        ...
        mPixely =
                (SecureSeekBarPreference) findPreference(PIXEL_Y);
        ...
        mCollapse =
                (SecureSeekBarPreference) findPreference(PIXEL_COLLAPSE);
        ...
        mBg =
               (SecureSeekBarPreference) findPreference(PIXEL_BG);
        ...
        mRetract =
                (SecureSeekBarPreference) findPreference(PIXEL_RETRACT);
        ...
        mDiamond =
                (SecureSeekBarPreference) findPreference(PIXEL_DIAMOND);
        ...
        mDots =
                (SecureSeekBarPreference) findPreference(PIXEL_DOTS);
        ...
        mHome =
                (SecureSeekBarPreference) findPreference(PIXEL_HOME);
